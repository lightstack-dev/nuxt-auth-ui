...
This page covers the **technical design patterns** used in our components. For the module's overall purpose and philosophy, see the [Introduction](/introduction#design-philosophy).
::
...
<ASignUpForm :social="!isSimpleMode" :secondary="showHelp" />
...
This follows established conventions while maintaining the principle: *"Make the common case easy, and the edge cases possible"* - full-featured by default, easy to customize when needed.
...
```vue
<!-- We provide auth UI -->
<ASignUpForm />  <!-- Minimal sign-up -->
<ASignInForm />  <!-- Sign-in -->
<AUserMenu />    <!-- Auth-related profile management -->

<!-- You handle app-specific needs -->
<MyOnboardingWizard />  <!-- Your custom onboarding -->
<MyProfileForm />        <!-- Your domain-specific fields -->
```
